...
\begin{table}[ht]
	...
	\resizebox{0.75\textwidth}{!}{% Verkleinert die gesamte Tabelle auf 90 % der Textbreite
		...
		\begin{tabular}{|m{5cm}|m{7cm}|}
			...
			\hline
			\centering\includegraphics[width=2cm]{Legende/Schütz.png} & \centering Contactor \tabularnewline
			\hline
